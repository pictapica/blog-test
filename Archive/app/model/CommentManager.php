...
class CommentManager extends Manager {
    ...
    public function getComments($postId) {
        ...
        $comments = $this->_db->prepare('SELECT id, author, comment, DATE_FORMAT(comment_date, \'%d/%m/%Y à %Hh%imin%ss\') AS comment_date_fr FROM comments WHERE post_id = ? ORDER BY comment_date DESC');
    ...
    public function postComment($postId, $author, $comment, $moderation) {    
        ...
        $comments = $this->_db->prepare('INSERT INTO comments(post_id, author, comment, comment_date, moderation) VALUES(:postID,:author , :comment, NOW(), 0)');
