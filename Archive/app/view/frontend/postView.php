...
<div class='container-fluid'>
    ...
    <div class="row">
        ...
        <div class="col-lg-10" id="comments">
            ...
            while ($comment = $comments->fetch()) {
                ...
                <form action="index.php?c=CommentController&amp;a=report" method="post">
                    <input type="hidden" name="id" value=<?= $comment['id'] ?>>
                    <input type="submit">
                    <!-- <a href="index.php?c=CommentController&a=report&id=#comments" style ="font-size: 0.7em; color: #e5a5a5"> Signaler</a> -  -->
    ...
    <div class="row">
        ...
        <div class="comments col-lg-10">
            ...
            <form action="index.php?c=CommentController&amp;a=addComment&amp;id=<?= $_GET['id']?>" method="post">
